	...
	.numOfVms = 1,
	{
		// VM0 LCS configuration
		{
			...
			.ipv6StaticGW = VM0_DEFAULT_GW,
			{
				...
				{
					.if_device_node_name = "/dev/lcs_em0",
					/*
					...
					*/
					...
					.macAddr = {0x50,0x61,0x5f,0x0e,0xd4,0xd1},
					.selfAddr = IP4_SOCKADDR_INIT(10,168,20,21),
					.selfNetMask = IP4_SOCKADDR_INIT(255,255,255,0),
					.selfBroadcastAddr = IP4_SOCKADDR_INIT(10,168,20,255),
					// 5001:db8:4672:6565:2026:5044:2d44:50d1
					.selfAddr6 = IP6_SOCKADDR_INIT(0x50, 0x01, 0x0d, 0xb8, 0x46, 0x72, 0x65, 0x65, 0x20, 0x26, 0x50, 0x44, 0x2d, 0x44, 0x50, 0xd1, (64)),

					.numOfPeers = 5,
					.ip2macPeers = {
						{
							.peerIpAddr = IP6_SOCKADDR_INIT( 0x20, 0x01, 0x0d, 0xb8, 0x46, 0x72, 0x65, 0x65, 0x20, 0x26, 0x50, 0x44, 0x2d, 0x44, 0x40, 0xd3, (64)),
							.peerMacAddr = { 0x80,0x61,0x5f,0x0e,0xd4,0xd3 }
						},
						// serial IPv4
						{
							.peerIpAddr = IP4_SOCKADDR_INIT(10,168,20,21),
							.peerMacAddr = { 0x50,0x61,0x5f,0x0e,0xd4,0xd1 }
						},
						// headless IPv4
						{
							.peerIpAddr = IP4_SOCKADDR_INIT(10,168,20,22),
							.peerMacAddr = { 0x50,0x61,0x5f,0x0e,0xd4,0xd2 }
						},
						// serial IPv6
						{
						// 5001:db8:4672:6565:2026:5044:2d44:50d1
							.peerIpAddr = IP6_SOCKADDR_INIT( 0x50, 0x01, 0x0d, 0xb8, 0x46, 0x72, 0x65, 0x65, 0x20, 0x26, 0x50, 0x44, 0x2d, 0x44, 0x50, 0xd1, (64)),
							.peerMacAddr = { 0x50,0x61,0x5f,0x0e,0xd4,0xd1 }
						},
						// headless IPv6
						// 5001:db8:4672:6565:2026:5044:2d44:50d2
						{
							.peerIpAddr = IP6_SOCKADDR_INIT( 0x50, 0x01, 0x0d, 0xb8, 0x46, 0x72, 0x65, 0x65, 0x20, 0x26, 0x50, 0x44, 0x2d, 0x44, 0x50, 0xd2, (64)),
							.peerMacAddr = { 0x50,0x61,0x5f,0x0e,0xd4,0xd2 }
						},
					},
